...
### 🛠️ Stack Tecnológico
*Una base científica sólida + herramientas modernas para construir soluciones de extremo a extremo.*
...
- ![Docker](https://img.shields.io/badge/Docker-2496ED.svg?style=flat-square&logo=docker&logoColor=white) Contenedores para despliegue de modelos (conceptos fundamentales completados).
- ![Plotly](https://img.shields.io/badge/Plotly-3F4F75.svg?style=flat-square&logo=plotly&logoColor=white) Visualización interactiva para dashboards climáticos.
- ![FastAPI](https://img.shields.io/badge/FastAPI-009688.svg?style=flat-square&logo=fastapi&logoColor=white) APIs para servir modelos de ML.
